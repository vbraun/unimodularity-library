      ...
      const size_t minor_height, const size_t minor_width, const nested_minor_sequence::extension_type extension_type)
  {
    ...
    case nested_minor_sequence::ONE_ROW:
    {
          ...
          ++iter)
      {
        ...
        boost::one_bit_color_map<boost::vec_adj_list_vertex_id_map<boost::no_property, traits::vertices_size_type> > 
          bipartition(num_components, boost::get(boost::vertex_index, component_graph));
